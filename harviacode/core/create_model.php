...
$string .="\n\n class " . $m . " extends CI_Model{
  ...
  $string .="\n\n    // datatables
      function json() {
          ...
          '<a href=\"'.site_url($load_view\"$c_url/detail/$1\").'\" id=\"detail\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Detail\" class=\"text-primary\"><i class=\"fa fa-file\"></i></a>&nbsp;
           <a href=\"'.site_url($load_view\"$c_url/edit/$1\").'\" id=\"edit\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Edit\" class=\"text-warning \"><i class=\"fa fa-pencil\"></i></a>&nbsp;
           <a href=\"'.site_url($load_view\"$c_url/hapus/$1\").'\" id=\"hapus\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Hapus\" class=\"text-danger \"><i class=\"fa fa-trash\"></i></a>',
           '$pk');
