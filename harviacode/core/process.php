...
if (isset($_POST['generate']))
{
    ...
    if ($mvc =="mvc") {
      $direct_created_view = "views/content/";
      $direct_created      = "";
      $load_view           = "";
      $direct_url          = "";
    }else {
      $direct_url          = "config_item(\"cpanel\").";
      $load_view           = "config_item(\"cpanel\").";
      $direct_created      = "modules/$directori_modules/";
      $direct_created_view = "modules/$directori_modules/views/content/";
    }
